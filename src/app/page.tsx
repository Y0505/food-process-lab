  ...
  return (
    <main>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media(max-width:900px){.process-line-selected{left:18px;right:18px;bottom:76px;grid-template-columns:1fr auto;gap:12px}.selected-flow{display:none}.process-line-selected p{max-width:none}}
        ...
        @media(max-width:600px){.process-line-selected{left:10px;right:10px;bottom:68px;grid-template-columns:1fr}.process-line-selected .enter-equipment{justify-self:start}.process-line-selected h3{font-size:16px}}
      ` }} />
