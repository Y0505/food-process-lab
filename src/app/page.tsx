import { EquipmentInspectionRail } from "@/components/equipment-inspection-rail";
    ...
    <main className="food-process-app">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        *{box-sizing:border-box}
        ...
        .inspection-rail{margin:30px 12px 0;padding:28px;border:1px solid rgba(157,202,201,.11);border-radius:24px;background:linear-gradient(135deg,rgba(9,26,29,.92),rgba(3,11,14,.96));box-shadow:0 25px 80px rgba(0,0,0,.24)}
        .inspection-rail-head{display:flex;align-items:flex-end;justify-content:space-between;gap:28px;margin-bottom:20px}.inspection-kicker{display:block;color:#70d0bd;font-size:8px;font-weight:800;letter-spacing:1.8px}.inspection-rail h2{margin:8px 0 0;font-size:24px;letter-spacing:-.7px}.inspection-rail-head p{max-width:500px;margin:0;color:rgba(226,239,238,.4);font-size:10px;line-height:1.55;text-align:right}
        .inspection-tabs{display:flex;gap:7px;overflow-x:auto;padding:2px 0 11px}.inspection-tabs button{flex:1 0 112px;min-height:45px;border:1px solid rgba(157,202,201,.1);border-radius:10px;background:rgba(255,255,255,.025);color:rgba(225,239,238,.5);font-size:8px;text-align:left;padding:8px 10px;cursor:pointer;transition:.2s}.inspection-tabs button span{display:block;color:rgba(112,208,190,.55);font-size:7px;font-weight:800;letter-spacing:1px;margin-bottom:5px}.inspection-tabs button:hover{border-color:rgba(112,208,190,.3);color:#dcefeb}.inspection-tabs button.active{background:linear-gradient(180deg,rgba(51,125,114,.28),rgba(18,56,53,.32));border-color:rgba(112,208,190,.48);color:#eafff9;box-shadow:inset 0 0 24px rgba(70,184,164,.07)}
        .inspection-body{display:grid;grid-template-columns:minmax(280px,.85fr) minmax(0,1.35fr);gap:14px;margin-top:4px}.inspection-machine-card{position:relative;min-height:300px;padding:22px;border:1px solid rgba(157,202,201,.1);border-radius:17px;background:radial-gradient(circle at 50% 42%,rgba(73,166,149,.13),transparent 34%),rgba(255,255,255,.02);overflow:hidden}.inspection-machine-glow{position:absolute;left:50%;top:47%;width:180px;height:180px;transform:translate(-50%,-50%);border:1px solid rgba(112,208,190,.18);border-radius:50%;box-shadow:0 0 70px rgba(70,170,153,.08);pointer-events:none}.inspection-kind{position:relative;display:block;color:#70d0bd;font-size:7px;font-weight:800;letter-spacing:1.5px}.inspection-machine-card>strong{position:relative;display:block;margin-top:7px;font-size:17px}.inspection-machine-card>small{position:relative;display:block;max-width:310px;margin-top:5px;color:rgba(226,239,238,.38);font-size:9px;line-height:1.45}.inspection-schematic{position:absolute;inset:88px 18px 18px;display:grid;grid-template-columns:repeat(2,1fr);grid-auto-rows:minmax(35px,1fr);gap:7px;align-content:center}.inspection-node{position:relative;display:flex;align-items:center;gap:7px;padding:7px 8px;border:1px solid rgba(157,202,201,.08);border-radius:8px;background:rgba(3,13,16,.62);font-size:8px;color:rgba(235,246,244,.64)}.inspection-node i{width:7px;height:7px;flex:0 0 auto;border-radius:50%;background:#6ed1bc;box-shadow:0 0 10px rgba(110,209,188,.45)}.inspection-node span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .inspection-details{display:grid;grid-template-columns:1fr 1fr;gap:10px}.inspection-detail-block{padding:17px;border:1px solid rgba(157,202,201,.08);border-radius:15px;background:rgba(255,255,255,.018)}.inspection-detail-block>span{display:block;color:rgba(112,208,190,.68);font-size:7px;font-weight:800;letter-spacing:1.4px;margin-bottom:11px}.component-list{display:grid;gap:6px}.component-list>div{padding:8px 9px;border-radius:8px;background:rgba(255,255,255,.025)}.component-list b{display:block;font-size:8px;color:rgba(235,246,244,.72)}.component-list small{display:block;margin-top:3px;color:rgba(226,239,238,.3);font-size:7px;line-height:1.3}.flow-list{display:grid;gap:7px}.flow-row{padding:9px;border:1px solid rgba(157,202,201,.06);border-radius:8px;background:rgba(255,255,255,.02)}.flow-row b{display:block;color:#9ddbd0;font-size:8px}.flow-row span{font-size:7px;color:rgba(226,239,238,.46)}.flow-row i{font-style:normal;color:#70d0bd;padding:0 5px}.flow-row small{display:block;margin-top:4px;color:rgba(226,239,238,.25);font-size:7px}
